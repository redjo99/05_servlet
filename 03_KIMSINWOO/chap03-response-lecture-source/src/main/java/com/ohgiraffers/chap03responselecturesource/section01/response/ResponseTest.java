...
public class ResponseTest extends HttpServlet {
    ...
    /* 기본적인 요청-응답 순서
    * 1. 요청을 받아 처리한다 -> 파라미터 꺼내기
    * 2. 비즈니스 로직을 처리한다 -> DB접속 및 CRUD 수행
    * 3. 응답을 처리한다 -> resp를 이용해서 결과 웹을 만들고(동적 웹 HTML코드) 스트림을 통해서 클라이언트에게 출력한다
    * */
    @Override
...
//        resp.setContentType("text/html"); // 응답 데이터의 MIME 타입을 설정
